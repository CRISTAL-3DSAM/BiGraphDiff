...
GT = loadmat('features_DD/features_DD_GT_300_v3')#loadmat('features_NTU/features_GT_v2')
GT_class = GT['class']
GT = GT['features']
GT2 = loadmat('features_DD/features_DD_GT_300_full')#loadmat('features_NTU/features_GT_v2')
GT_class2 = GT2['class']
GT2 = GT2['features']

OURS = loadmat('features_OURS')
OURS_class = OURS['class']
OURS = OURS['features']

ACTOR = loadmat('features_DD/features_DD_ACTOR_300_v3')
ACTOR_class = ACTOR['class']
ACTOR = ACTOR['features']

MDIFF = loadmat('features_DD/features_DD_MDIFF_300_v3')
MDIFF_class = MDIFF['class']
MDIFF = MDIFF['features']

FVD_ACTOR = calculate_fvd(GT2,ACTOR)
FVD_OURS = calculate_fvd(GT2,OURS)
FVD_MDIFF = calculate_fvd(GT2,MDIFF)
