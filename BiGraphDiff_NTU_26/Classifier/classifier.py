...
_,test_loader = dataset.get_data_loaders(0,
                                                     shuffle=True,
...
log('       accuracy walking {top1:.6f} '.format(top1=class_accuracies[idx_label[0]]))
log('       accuracy kicking {top1:.6f} '.format(top1=class_accuracies[idx_label[1]]))
log('       accuracy pushing {top1:.6f} '.format(top1=class_accuracies[idx_label[2]]))
log('       accuracy shaking hands {top1:.6f} '.format(top1=class_accuracies[idx_label[3]]))
log('       accuracy exchanging {top1:.6f} '.format(top1=class_accuracies[idx_label[4]]))
log('       accuracy punching {top1:.6f} '.format(top1=class_accuracies[idx_label[5]]))
