...
def main():
    ...
    parser.add_argument('-data_dir', type=str,default='data/NTU')
    parser.add_argument('-train_file', type=str,default='data/NTU/Train.txt')
    ...
    opt.trg_pad = 1
    opt.data_input,opt.data_output,opt.max_frames = Load_a2m_NTU.Load_Data(opt.train_file,opt.data_dir,opt.nb_joints,opt.nb_classes)
    model = get_model(opt)
