...
def main():
    ...
    opt.data_input ,opt.data_output,opt.max_frames,opt.vocab_size,opt.annotations,nb_word,opt.l_motion,opt.cl_fold= Load_a2m_NTU.Load_Data(opt.train_file,opt.data_dir,int(opt.nb_joints/6))
